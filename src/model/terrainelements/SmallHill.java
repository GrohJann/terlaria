        ...
        terrainelement = new GraphicalObject[][]{
                {
                        ...
                        grass = new Grass(posX + (32 * 6), 32 * 16),
                        grass = new Grass(posX + (32 * 7), 32 * 16),
                        grass = new Grass(posX + (32 * 8), 32 * 16),
...

                {
                        ...
                        grass = new Grass(posX + (32 * 10), 32 * 17),
...

                {
                        ...
                        grass = new Grass(posX + (32 * 12), 32 * 18),
